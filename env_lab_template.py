...
PHPIPAM = {
    """
    - The delimiter_string is used to separate the "source" and "timestamp" in the "note" field  of hosts
    added into IPAM server via this project. It should not be present in the "note" field for hosts
